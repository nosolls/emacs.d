...
;; Install
(quelpa '(xah-fly-keys :repo "xahlee/xah-fly-keys" :fetcher github))
...
;; Adjustments for Ivy, Counsel, Swiper
...
(define-key xah-fly-command-map (kbd "SPC 0") 'delete-and-balance-window)
